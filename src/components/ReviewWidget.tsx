    ...
    <div className={`bg-white p-6 rounded-lg shadow-lg ${className}`}>
      ...
      <div className="space-y-3">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <span className="font-medium text-dark-grey">Google Business Profile</span>
          </div>
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded-lg">
        <p className="text-sm text-dark-grey">
          <strong>Note:</strong> Reviews help build trust and improve our services. 
          All reviews are subject to platform guidelines and policies.
        </p>
      </div>
    </div>
  );
